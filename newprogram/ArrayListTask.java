...
public class ArrayListTask{
   ...
   public String findStringAtIndex(List<String> list,int index){
    if(list==null){
      return null;
    }
       String str=null;
       ...
       if(length>=index){
          ...
          newIndex=checkIndex(length);
          str=findStringAtIndex(list,newIndex);
       }
      return str;
    }
   ...
   public List<String> addString(List<String> list,String str,int position){
      if(list==null){
      return null;
    }
    int newPosition=0;
    int length=list.size();
     if(length>=position){
       ...
       System.out.println("given position is greater than the list length");
          newPosition=checkIndex(length);
          list=addString(list,str,newPosition);
     }
      return list;
    }
   ...
   public List<Double> removeDecimalValueAtIndex(List<Double> decimalList,int position){
      if(decimalList==null){
         return null;
      }
      int newPosition=0;
      ...
      if(size>=position){ 
        ...
        /* newPosition=checkIndex(size);
         decimalList=removeDecimalValueAtIndex(decimalList,newPosition);*/
         decimalList=null;
      }
      return decimalList;
    } 
