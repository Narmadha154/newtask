...
public class ArrayListTaskRunner{
  ...
  case 8:
       List<String> list5=object.createStringArrayList();
        ...
        String newString=obj.findStringAtIndex(list5,index);
  ...
  case 10:
       ...
       List<String> addedList=obj.addString(list7,strSecond,position);
 ...
 case 15:
       ...
       List<Double> deciList=obj.removeDecimalValueAtIndex(doubleList1,removePosition);
       List<Double> deciList1=new ArrayList<>();
       if(deciList==null){
          System.out.println("Enter the correct index where the value to be removed:");
          int newRemovePosition=object.getIntegerInput();
          deciList1=obj.removeDecimalValueAtIndex(doubleList1,newRemovePosition);
        }
       int deciLength=deciList1.size();
       System.out.println("Arraylist after removing an element at given position:"+deciList1);
