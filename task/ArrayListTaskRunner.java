...
public class ArrayListTaskRunner{
  ...
  case 8:
       List<String> list5=createStringArrayList();
        ...
        String newString=ArrayListTask.findStringAtIndex(list5,index);
        System.out.println("ArrayList elements:"+list5);
        System.out.println("String at given index:"+newString);
